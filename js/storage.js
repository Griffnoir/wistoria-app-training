...
export const EXERCISE_LIBRARY = [
  ...
  // Nouveaux exercices
  {
    ...
    sets: 2,
    rest: 20,
    target: "Ouvrir les rotateurs externes et les hanches",
    description: "Jambe avant pliée, jambe arrière tendue, buste droit ou penché en avant.",
    cues: "Respire profondément dans la hanche avant. Ne force pas le genou.",
    media: "assets/images/stretch-hips.svg"
  },
  {
    name: "Lateral Lunge",
    ...
    sets: 3,
    rest: 15,
    target: "Étirement latéral des adducteurs et mobilité des hanches",
    description: "Fente large sur le côté, jambe tendue, bassin bas.",
    cues: "Garde le buste droit et descends en poussant les hanches en arrière.",
    media: "assets/images/stretch-split.svg"
  },
  {
    ...
    sets: 3,
    rest: 20,
    target: "Souplesse des ischio-jambiers pour les coups de pied hauts",
    description: "Assis, jambe tendue, penche-toi en avant en gardant le dos droit.",
    cues: "Tire tes orteils vers toi et expire en t'abaissant.",
    media: "assets/images/stretch-split.svg"
  },
  {
    ...
    sets: 2,
    rest: 30,
    target: "Mobilité des chevilles et des hanches",
    description: "Accroupi, pieds au sol, buste droit, coudes poussant les genoux.",
    cues: "Maintiens la position, respire calmement.",
    media: "assets/images/martial-flow.svg"
  },
  {
    ...
    sets: 2,
    rest: 15,
    target: "Mobilité des épaules et ouverture thoracique",
    description: "Avec une bande ou un bâton, passe les bras de l'avant vers l'arrière.",
    cues: "Contrôle le mouvement, ne force pas si douleur.",
    media: "assets/images/martial-flow.svg"
  }
];
